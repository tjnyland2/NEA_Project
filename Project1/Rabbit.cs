...
namespace Project1
{
    ...
    public class Rabbit //Rabbit Class
    {
        ...
        public int Width => (int)(Texture?.Width * DrawScale ?? 8);//if null set to 8
        public int Height => (int)(Texture?.Height * DrawScale ?? 8);//if null set to 8
